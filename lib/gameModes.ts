...
export const GAME_MODES: Record<string, GameModeConfig> = {
  classic: {
    id: 'classic',
    name: 'Classic',
    description: 'Standard rules - word limit matches prompt length',
  ...
  speedrun: {
    id: 'speedrun',
    name: 'Speed Run',
    description: '30 seconds per turn - think fast!',
    wordLimitMultiplier: 1,
  ...
  chaos: {
    id: 'chaos',
    name: 'Chaos',
    description: '2x word limit - describe everything!',
    wordLimitMultiplier: 2,
    turnTimerEnabled: false,
    turnTimerSeconds: 0,
    imageQuality: 'standard',
  },
  ...
  verbose: {
    id: 'verbose',
    name: 'Verbose',
    description: 'No word limit - write an essay!',
    wordLimitMultiplier: Infinity,
    turnTimerEnabled: false,
    turnTimerSeconds: 0,
    imageQuality: 'standard',
  },
